...
SSH_PRIVATE_KEY_PATH=C:/Users/Username/.ssh/id-rsa-private
...
6. Для предварительного просмотра собранного бандла (возможно потребуется вручную подключить исключаемые в dev-режиме скрипты):
   ...
   npm run preview
   ```
7. Для публикации на сервер требуется указать путь к приватному ключу в `.env`

   установить зависимости пакета (если не была установлена ранее)
...
- Не храните секретные данные (пароли) и ключи шифрования в публичных репозиториях.
